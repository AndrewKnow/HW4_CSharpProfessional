...
namespace HW4_CSharpProfessional
{
    internal class Program
    {
        ...
        ///     Выбор минимального и максимального значения диапазона абстрагирован в интерфейсе INumGenerator и определен в реализации интерфейса
        ///     GenerateMaxMinNum. Класс NumberGenerator делегирует назначение рандомного диапазона методу Generat объекта INumGenerator.
